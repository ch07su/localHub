  ...
  <div class="chat-header">
    ...
    <button class="close-btn" @click="isChatOpen = false">X</button>
      ...
      <div class="category-buttons">
        <button
          v-for="category in [ '관광지', '레포츠', '문화시설', '쇼핑', '숙박']"
          :key="category"
          :class="[
            'category-btn',
...
const messages = ref([
  { sender: 'bot', text: '안녕하세요! 서울 지역 정보 AI 도우미입니다. 위 카테고리를 먼저 선택하시고 질문해주세요!' }
]);
const input = ref('');
          ...
          { 
            ...
            content: `[역할 정의]
              ...
              1. 상세 정보 즉시 제공 규칙 (최우선):
                - 사용자가 목록에 있는 특정 장소 이름을 언급하며 정보를 요청하는 경우(예: "~에 대해 알려줘", "거기 주소가 어떻게 돼?", "신촌문화발전소, 서대문구 관광지")에는 "원하시면 알려주겠다" 같은 되묻기 단계를 절대 거치지 말고, 즉시 해당 장소의 [상세 정보(주소, 전화번호, 설명 등)]를 제공하세요.
              ...
              User: "서대문구 문화시설"
              AI: "서대문구의 문화시설로는 금호아트홀 연세, 서대문자연사박물관, 신촌문화발전소가 있습니다. 정보를 원하시는 장소가 있으실까요?"
